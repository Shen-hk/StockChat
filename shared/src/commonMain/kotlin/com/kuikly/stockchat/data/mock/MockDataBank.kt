...
object MockDataBank {
    ...
    private val seeds = mapOf(
        ...
        // 全局搜索页扩充标的（沪深A股 / 港股 / 美股 / 指数）
        "600036.SH" to SeedQuote(39.85, 39.40, 7.21, 0.95, 1_005_000_000_000.0),
        "002594.SZ" to SeedQuote(271.60, 265.30, 22.54, 4.91, 790_000_000_000.0),
        "688981.SH" to SeedQuote(92.45, 89.10, 108.30, 5.12, 738_000_000_000.0),
        "09988.HK" to SeedQuote(118.30, 115.90, 16.83, 1.92, 2_260_000_000_000.0),
        "03690.HK" to SeedQuote(96.55, 99.20, 24.10, 3.21, 594_000_000_000.0),
        "01810.HK" to SeedQuote(24.35, 23.80, 34.60, 3.80, 609_000_000_000.0),
        "AAPL.US" to SeedQuote(231.40, 228.68, 35.20, 51.30, 3_500_000_000_000.0),
        "TSLA.US" to SeedQuote(342.75, 333.10, 72.40, 12.60, 1_100_000_000_000.0),
        "NVDA.US" to SeedQuote(138.25, 135.40, 52.10, 48.70, 3_390_000_000_000.0),
        "399001.SZ" to SeedQuote(12876.40, 12750.15, 0.0, 0.0, 0.0),
        "399006.SZ" to SeedQuote(2655.80, 2612.35, 0.0, 0.0, 0.0),
        "HSI.HK" to SeedQuote(24350.60, 24198.30, 0.0, 0.0, 0.0),
    )
