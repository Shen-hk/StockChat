...
object ModelPresets {
    ...
    val all: List<ModelPreset> = listOf(
        ModelPreset(
            ...
            keyHint = "在 platform.deepseek.com 创建 API Key；deepseek-reasoner 为深度思考模型。",
        ),
        ModelPreset(
            id = "kimi",
            name = "Kimi",
        ...
        ModelPreset(
            ...
            models = listOf("doubao-seed-1-6-250615"),
        ...
        ModelPreset(
            ...
            models = listOf("hunyuan-turbos-latest", "hunyuan-lite"),
            keyHint = "在腾讯云混元大模型控制台创建 API Key；hunyuan-lite 免费。",
        ),
        ModelPreset(
            id = "openai",
            name = "OpenAI",
