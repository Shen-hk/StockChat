package com.kuikly.stockchat.chat.island.component
...
/**
 * Chat 顶部商品岛：ChatTopNav（导航/星标/菜单）+ StockIsland（776 行的岛体与手势）
 * + CompareIslandSlot（对比岛）。
 *
 * 2026-09-12（doc 47 B-2）从 page/components/AppChrome.kt 原样拆出：纯物理归档，
 * StockIsland 的手势阈值、动画节奏、层叠参数一行未改。
 */
